...
Source0  : https://cpan.metacpan.org/authors/id/M/MT/MTHURN/I18N-Charset-1.417.tar.gz
...
Requires: perl-I18N-Charset-man
Requires: perl(IO::Capture::Stderr)
...
%package man
Summary: man components for the perl-I18N-Charset package.
Group: Default

%description man
man components for the perl-I18N-Charset package.


%prep
tar -xf %{SOURCE1}
cd ..
%setup -q -n I18N-Charset-1.417
mkdir -p %{_topdir}/BUILD/I18N-Charset-1.417/deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/I18N-Charset-1.417/deblicense/
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/I18N/Charset.pm
